...
function settings(){
    document.getElementById("topBarText").innerHTML = "<i class='fa fa-cogs' aria-hidden='true'></i> Settings";
    close();
}

function setRange(val) {
    $('.rangeLab').removeClass('rangeLabActive');
    $(val).addClass('rangeLabActive');
}
